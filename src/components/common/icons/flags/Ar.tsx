...
const Ar: React.FC<ArProps> = ({size = '35px', round = false}) => {
  return (
    <svg
    ...
    >
      ...
      <use xlinkHref='#c' width='100%' height='100%' transform='rotate(90 256 256)' />
      <use xlinkHref='#c' width='100%' height='100%' transform='rotate(180 256 256)' />
      <use xlinkHref='#c' width='100%' height='100%' transform='rotate(-90 256 256)' />
      ...
      />
      <use xlinkHref='#d' width='100%' height='100%' transform='matrix(-1 0 0 1 512.3 0)' />
      <use xlinkHref='#e' width='100%' height='100%' transform='matrix(-1 0 0 1 512.3 0)' />
      <use xlinkHref='#f' width='100%' height='100%' transform='translate(19.3)' />
      <use xlinkHref='#g' width='100%' height='100%' transform='matrix(-1 0 0 1 512.3 0)' />
      <path
        fill='#85340a'
      ...
      />
      <use xlinkHref='#h' width='100%' height='100%' transform='translate(-19.6)' />
      <circle id='f' cx='246.3' cy='252.1' r='2' fill='#85340a' strokeWidth='1' />
      <path
        id='g'
        fill='#85340a'
        strokeWidth='1'
