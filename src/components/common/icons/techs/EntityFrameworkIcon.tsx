  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id='O' spreadMethod='pad' y2='384.152' x2='185.906' y1='415.525' x1='185.906' xlinkHref='#CP'>
        ...
        <linearGradient id='u' spreadMethod='pad' y2='417.334' x2='151.875' y1='341.213' x1='151.875' xlinkHref='#CP'>
          <stop offset='0' stop-color='#231f20' />
        ...
        <linearGradient id='AG' spreadMethod='pad' y2='361.846' x2='249.375' y1='416.494' x1='249.375' xlinkHref='#CP'>
        ...
        <linearGradient id='AV' spreadMethod='pad' y2='420.329' x2='130.625' y1='344.213' x1='130.625' xlinkHref='#CP'>
          <stop offset='0' stop-color='#231f20' />
          <stop offset='1' stop-color='#fff' />
        </linearGradient>
        ...
        <linearGradient id='Ak' spreadMethod='pad' y2='289.807' x2='88.162' y1='393.9' x1='146.375' xlinkHref='#CP'>
          <stop offset='0' stop-color='#231f20' />
        ...
        <linearGradient id='BI' spreadMethod='pad' y2='389.349' x2='251.906' y1='420.525' x1='251.906' xlinkHref='#CP'>
          <stop offset='0' stop-color='#231f20' />
          <stop offset='1' stop-color='#fff' />
        </linearGradient>
        ...
        <linearGradient id='Ba' spreadMethod='pad' y2='416.181' x2='162.555' y1='407.428' x1='162.555' xlinkHref='#CP'>
        ...
        <linearGradient id='Bs' spreadMethod='pad' y2='410.247' x2='231.313' y1='361.15' x1='231.313' xlinkHref='#CP'>
          <stop offset='0' stop-color='#231f20' />
          <stop offset='1' stop-color='#fff' />
        </linearGradient>
        ...
        <linearGradient id='Bz' spreadMethod='pad' y2='337.71' x2='181.125' y1='414.088' x1='181.125' xlinkHref='#CP'>
        ...
        <linearGradient id='CA' spreadMethod='pad' y2='337.638' x2='184.188' y1='415.963' x1='184.188' xlinkHref='#CP'>
        ...
        <linearGradient id='CB' spreadMethod='pad' y2='416.972' x2='199.875' y1='354.65' x1='199.875' xlinkHref='#CP'>
          <stop offset='0' stop-color='#1c63b7' />
          <stop offset='.5' stop-color='#33bdf2' />
          <stop offset='1' stop-color='#33bdf2' />
        </linearGradient>
        <linearGradient id='CC' spreadMethod='pad' y2='342.579' x2='195.813' y1='423.9' x1='195.813' xlinkHref='#CP'>
        ...
        <linearGradient id='CD' spreadMethod='pad' y2='337.051' x2='189.313' y1='423.525' x1='189.313' xlinkHref='#CP'>
        ...
        <linearGradient id='CE' spreadMethod='pad' y2='416.954' x2='246.375' y1='356.244' x1='246.375' xlinkHref='#CP'>
          <stop offset='0' stop-color='#136ab4' />
          <stop offset='.315' stop-color='#59caf5' />
          <stop offset='.6' stop-color='#59caf5' />
          <stop offset='1' stop-color='#59caf5' />
        </linearGradient>
        <linearGradient id='CF' spreadMethod='pad' y2='416.813' x2='136.313' y1='354.65' x1='136.313' xlinkHref='#CP'>
          <stop offset='0' stop-color='#318ed5' />
          <stop offset='.675' stop-color='#38a7e4' />
          <stop offset='1' stop-color='#38a7e4' />
        </linearGradient>
        <linearGradient id='CG' spreadMethod='pad' y2='414.888' x2='140.25' y1='354.463' x1='140.25' xlinkHref='#CP'>
          <stop offset='0' stop-color='#05a1e6' />
          <stop offset='1' stop-color='#05a1e6' />
        </linearGradient>
        <linearGradient id='CH' spreadMethod='pad' y2='402.367' x2='143.563' y1='351.307' x1='143.563' xlinkHref='#CP'>
        ...
        <linearGradient id='CI' spreadMethod='pad' y2='410.014' x2='135.55' y1='354.65' x1='145.313' xlinkHref='#CP'>
          <stop offset='0' stop-color='#165096' />
          <stop offset='.104' stop-color='#165096' />
          <stop offset='1' stop-color='#0d82ca' />
        </linearGradient>
        <linearGradient id='CJ' spreadMethod='pad' y2='414.896' x2='236.063' y1='385.963' x1='236.063' xlinkHref='#CP'>
          <stop offset='0' stop-color='#05a1e6' />
          <stop offset='.649' stop-color='#05a1e6' />
          <stop offset='.874' stop-color='#0495d6' />
          <stop offset='1' stop-color='#0495d6' />
        </linearGradient>
        <linearGradient id='CK' spreadMethod='pad' y2='350.933' x2='237.83' y1='417.65' x1='249.594' xlinkHref='#CP'>
          <stop offset='0' stop-color='#38a7e4' />
          <stop offset='.357' stop-color='#38a7e4' />
          <stop offset='.962' stop-color='#0e88d3' />
          <stop offset='1' stop-color='#0e88d3' />
        </linearGradient>
        <linearGradient id='CL' spreadMethod='pad' y2='352.093' x2='239.063' y1='415.213' x1='239.063' xlinkHref='#CP'>
          <stop offset='0' stop-color='#168cd4' />
          <stop offset='.5' stop-color='#1c87cc' />
          <stop offset='1' stop-color='#154b8d' />
        </linearGradient>
        <linearGradient id='CM' spreadMethod='pad' y2='410.471' x2='173.102' y1='416.502' x1='158.563' xlinkHref='#CP'>
          <stop offset='0' stop-color='#97d6ee' />
          <stop offset='.703' stop-color='#55c1ea' />
          <stop offset='1' stop-color='#55c1ea' />
        </linearGradient>
        <linearGradient id='CN' spreadMethod='pad' y2='414.512' x2='178.479' y1='409.307' x1='166.996' xlinkHref='#CP'>
          <stop offset='0' stop-color='#7accec' />
          <stop offset='.335' stop-color='#7accec' />
          <stop offset='.841' stop-color='#3fb7ed' />
          <stop offset='1' stop-color='#3fb7ed' />
        </linearGradient>
        <linearGradient id='CO' spreadMethod='pad' y2='350.007' x2='230.688' y1='411.744' x1='230.688' xlinkHref='#CP'>
